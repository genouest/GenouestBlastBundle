...
class BlastType extends AbstractType
{
    public function buildForm(FormBuilder $builder, array $options)
    {
        ...
        $builder->add('fileSeq', 'file', array('type' => 'object'));
        ...
        $builder->add('persoBankFile', 'file', array('type' => 'object'));
        ...
        $builder->add('psiPSSM', 'file', array('type' => 'object'));
        $builder->add('phiPattern', 'file', array('type' => 'object'));
    }
